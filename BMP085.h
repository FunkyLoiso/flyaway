...
void BMP085_read_temp(int32_t* temperature, int* is_new_value); /* Doesn't block, writes 1 to is_new_value if the value has changed since last BMP085_schedule_press_temp_update call */
